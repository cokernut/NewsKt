...
public class SettingsFragment extends PreferenceFragment implements Preference.OnPreferenceClickListener {
    ...
    public boolean onPreferenceClick(Preference preference) {
        if (mIsAutoUpdate == preference) {
            preference.getEditor().putBoolean(top.cokernut.newskt.utils.PrefUtils.PRE_AUTO_UPDATE, mIsAutoUpdate.isChecked());
    ...
    private void initPreference() {
        ...
        mVersionPre.setTitle("版本：" + top.cokernut.newskt.utils.VersionUtils.setUpVersionName(getActivity()));
    }
}
